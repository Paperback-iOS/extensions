import type { Tracker, SourceManga } from "@paperback/types";
import type { MUSeriesModelV1 } from '../models/bu-api';
...
export function parseMangaInfo(series: MUSeriesModelV1): SourceManga {
    return {
        titles: [
            series.title,
